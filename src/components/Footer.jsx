...
const Footer = () => {
  return (
    <footer className="bg-white">
      <div className="max-w-[1211px] w-full mx-auto px-4 py-6 sm:px-6 sm:py-8">
        <div className="flex flex-col p-4 sm:p-5 bg-[#fbfbfb] xl:flex-row  items-center gap-6 sm:gap-8">
          <div className="flex-1 grid bg-[#fbfbfb] grid-cols-1 xl:grid-cols-3 gap-4 sm:gap-6">
            <div className="flex flex-col items-start p-3 sm:p-4">
              ...
              />
              <h3 className="mt-3 sm:mt-4 font-bold text-[15px] sm:text-[17px] leading-[94%] text-[#3d3d3d] font-family">
                Garden Care
              </h3>
              <p className="mt-2 font-normal text-xs sm:text-sm leading-[157%] text-[#727272] font-family">
          ...
          <div className="md:w-[354px] pt-[20px] sm:pt-[35px] bg-[#fbfbfb] flex flex-col">
            <h3 className="font-bold text-base sm:text-lg leading-[89%] text-[#3d3d3d] font-family mb-3 sm:mb-4">
            ...
            <form className="flex relative gap-2">
              <input
                ...
                className="flex-1 h-8 sm:h-10 shadow-[0_0_20px_0_rgba(0,0,0,0.06)] min-w-[250px] sm:min-w-[354px] px-3 py-1 sm:py-2 border border-gray-300 rounded-md font-normal text-xs sm:text-sm leading-[114%] text-[#acacac] font-family focus:outline-none focus:ring-2 focus:ring-green-600"
              />
              <button
                type="submit"
                className="px-3 sm:px-4 absolute right-0 py-1 sm:py-2 font-bold w-[60px] sm:w-[85px] h-8 sm:h-10 rounded-[0_6px_6px_0] bg-[#46a358] text-base sm:text-lg leading-[89%] text-white cursor-pointer font-family hover:bg-green-700 transition-colors"
              >
                Join
              </button>
            </form>
            <p className="mt-3 sm:mt-4 font-normal text-[12px] sm:text-[13px] leading-[169%] text-[#727272] font-family">
      ...
      <div className="max-w-[1211px]  overflow-x-auto w-full h-[60px] sm:h-[88px] bg-[rgba(70,163,88,0.1)] mx-auto px-4 sm:px-6 flex  items-center justify-start gap-4 sm:gap-20">
        <div className="inline-flex min-w-max items-start sm:items-center gap-4 sm:gap-20">
          <div className="">
          ...
          <div className="flex gap-4 sm:gap-20">
            <div className="flex items-center gap-2">
              ...
              <span className="font-normal text-xs sm:text-sm leading-[157%] text-[#3d3d3d] font-family">
      ...
      <div className="max-w-[1211px] w-full border-b-[0.30px] border-solid border-[rgba(70,163,88,0.5)] mx-auto px-4 py-6 sm:py-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          <div>
            <h4 className="font-bold text-base sm:text-lg leading-[89%] text-[#3d3d3d] font-family mb-3 sm:mb-4">
              My Account
            </h4>
            <ul className="space-y-1 sm:space-y-2 font-normal text-xs sm:text-sm leading-[214%] text-[#3d3d3d] font-family">
              <li>
          ...
          <div>
            ...
            <div className="flex gap-2 sm:gap-3 mb-4">
              <button className="border cursor-pointer flex justify-center items-center w-7 sm:w-8 h-7 sm:h-8 rounded border-solid border-[rgba(70,163,88,0.2)] hover:bg-green-50 transition-colors">
                <svg
                  width="8"
                  height="16"
                  viewBox="0 0 8 16"
            ...
            <h4 className="font-bold mt-6 sm:mt-10 text-base sm:text-lg leading-[89%] text-[#3d3d3d] font-family mb-3 sm:mb-4">
              We accept
            </h4>
            <div className="flex gap-1 sm:gap-2">
              <img src={image16} alt="" className="h-6 sm:h-8" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="py-3 sm:py-4">
        <div className="max-w-[1211px] w-full mx-auto px-4 font-normal text-center text-xs sm:text-sm leading-[214%] text-[#3d3d3d] font-family">
